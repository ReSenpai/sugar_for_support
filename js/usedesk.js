...
const collectTemplate = () => {
    ...
    addButton('Откл АП', ['Кино', 'Аккаунт', 'Выключение автопродления', 'Отключение автопродления']);
    addButton('Отвязать карту', ['Кино', 'Фин вопросы', 'Проблемы с оплатой', 'Отвязка карты']);
    addButton('АП', ['Кино', 'Фин вопросы', 'Проблемы с оплатой', 'Автоматическое списание средств']);
    addButton('Подписка', ['Кино', 'Продукт', 'Подписки', 'Консультация по подпискам']);
